"""
Base Module for Pytorch Dataset
For TEMOS, we need to handle multimodal data(motion & text). So we can't use the vanilla dataloader from pytorch directly.
Therefore, here we follow the basic data module to handle both text and motion dataset
...
from model.preprocessing.utils import collate_datastruct_and_text
